...
V_33_R0 = I_33_cab0*R0_cab;
V_5_R0 = I_5_cab0*R0_cab;

P_33_R0 = R0_cab.*I_33_cab0.^2;
P_5_R0 = R0_cab.*I_5_cab0.^2;

eff_33_cab0 = 0.78*(1 - exp(f_33(I_33_cab0)));
eff_5_cab0 = 0.84*(1 - exp(f_5(I_5_cab0)));

P_33_in_cab0 = (P_33 + P_33_R0)./eff_33_cab0;
P_5_in_cab0 = (P_5 + P_5_R0)./eff_5_cab0;
...
V_15_R0 = I_15_cab0*R0_cab;
V_m15_R0 = I_m15_cab0*R0_cab;

P_15_R0 = R0_cab.*I_15_cab0.^2;
P_m15_R0 = R0_cab.*I_m15_cab0.^2;

eff_15_cab0 = 0.91*( 1 - exp(f_15(I_15_cab0)));
eff_m15_cab0 = 0.91*( 1 - exp(f_15(I_m15_cab0)));

P_15_in_cab0 = (P_15 + P_15_R0)./eff_15_cab0;
P_m15_in_cab0 = (P_m15 + P_m15_R0)./eff_m15_cab0;
...
V_33_R1 = I_33_cab1*R1_cab;
V_5_R1 = I_5_cab1*R1_cab;

P_33_R1 = R1_cab.*I_33_cab1.^2;
P_5_R1 = R1_cab.*I_5_cab1.^2;

eff_33_cab1 = 0.78*(1 - exp(f_33(I_33_cab1)));
eff_5_cab1 = 0.84*(1 - exp(f_5(I_5_cab1)));

P_33_in_cab1 = (P_33 + P_33_R1)./eff_33_cab1;
P_5_in_cab1 = (P_5 + P_5_R1)./eff_5_cab1;
...
P_15_R1 = R1_cab.*I_15_cab1.^2;
P_m15_R1 = R1_cab.*I_m15_cab1.^2;

eff_15_cab1 = 0.91*( 1 - exp(f_15(I_15_cab1)));
eff_m15_cab1 = 0.91*( 1 - exp(f_15(I_m15_cab1)));

P_15_in_cab1 = (P_15 + P_15_R1)./eff_15_cab1;
P_m15_in_cab1 = (P_m15 + P_m15_R1)./eff_m15_cab1;
...
elseif Case == 4
    P_BUS_sym = zeros(size(P_BUS_tot));
end
