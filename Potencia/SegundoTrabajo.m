...
t = 0:0.1:2*Periodo;          % Tiempo de simulación [s]
...
hold on
grid on
plot(theta,P_KF,LineWidth=2)
plot(theta,P_DAS,LineWidth=2,LineStyle='--')
plot(theta,P_PC,LineWidth=2,LineStyle=':')
plot(theta,P_1D2R,LineWidt=2)
legend('KF','DAS','PC','1D-2R')
hold off
...
hold on
grid on
plot(theta,IV_KF(:,2),LineWidth=2)
plot(theta,IV_DAS(:,2),LineWidth=2,LineStyle='--')
plot(theta,IV_PC(:,2),LineWidth=2,LineStyle=':')
plot(theta,IV_1D2R(:,2),LineWidth=2)
legend('KF','DAS','PC','1D-2R')
hold off
subplot(1,2,2)
hold on
...
plot(theta,IV_DAS(:,1),LineWidth=2,LineStyle='--')
plot(theta,IV_PC(:,1),LineWidth=2,LineStyle=':')
...
hold on
grid on
plot(theta,Temperatura,LineWidth=2)
hold off
...
plot(theta,IV_DAS_T(:,1),LineWidth=2,LineStyle='--')
plot(theta,IV_PC_T(:,1),LineWidth=2,LineStyle=':')
...
hold on
grid on
plot(theta,IV_KF_T(:,2),LineWidth=2)
plot(theta,IV_DAS_T(:,2),LineWidth=2,LineStyle='--')
plot(theta,IV_PC_T(:,2),LineWidth=2,LineStyle=':')
plot(theta,IV_1D2R_T(:,2),LineWidth=2)
legend('KF','DAS','PC','1D-2R')
hold off
